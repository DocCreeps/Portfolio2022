<Section>
    <h1 class="text-5xl text-center t font-bold mt-20 mb-10 -ml-3 underline" id="formation" >Formations</h1>
    ...
    <div class="container mx-auto w-full h-full">
        <div class="relative wrap overflow-hidden p-10 h-full">
            ...
            <div class="mb-8 flex justify-between items-center w-full right-timeline">
                ...
                <div class="z-20 flex items-center order-1 bg-green-700 shadow-xl w-8 h-8 rounded-full">
                </div>
                <div class="order-1  text-center rounded-lg shadow-lg bg-gray-100 w-5/12 px-6 py-4">
                    ...
                    <p class="text-gray-700 mb-2 sm:text-xs md:text-xs">J'ai effectuer ma licence RPI(Responsable de Projets Informatique) ainsi que mon master ESI(Expert en Système d'Informations) Option développeur au seins de l'école Isitech en alternance.</p>
                </div>
            </div>
            ...
            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                ...
                <div class="order-1  text-center rounded-lg shadow-lg bg-gray-100 w-5/12 px-6 py-4">
                    ...
                    <p class="text-gray-700 mb-2">J'ai effectuer mon BTS SIO (Services Informatiques aux Organisations) Option SLAM(Solution Logiciels et Applications Metiers) au Centre Scolaire Notre Dame a Villefranche-sur-Saône.<br/> Avec ce BTS j'ai pu apprendre les bases de la programmations  </p>
                </div>
            </div>
            ...
            <div class="mb-8 flex justify-between items-center w-full right-timeline">
                ...
                <div class="order-1  text-center rounded-lg shadow-lg bg-gray-100 w-5/12 px-6 py-4">
                    ...
                    <p class="text-gray-700 mb-2 overflow-auto">J'ai effectuer mon BEP et mon BAC Professionnel SEN(Système Électronique et Numérique) option TR (Telecom et Réseaux) au sein du lycée Le marais sainte thérèse a Saint-Étienne.<br/> Ce BAC Pro m'a appris les bases de l'informatique et de l'électronique </p>
                </div>
            </div>
