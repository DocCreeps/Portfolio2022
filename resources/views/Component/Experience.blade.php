    ...
    <h1 class="text-5xl text-center text-gray-700 font-bold mt-20 mb-20 -ml-6 underline">Experiences Professionnelles</h1>
        ...
        <div class="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-blue-50">
            ...
            <div class="flex flex-row-reverse md:contents">
                <div class="bg-gray-100 col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md text-center xpReveal">
                    ...
                    <p class="text-gray-700 mb-6">Alternance effectuer dans le cadre de ma formation Expert en Systèmes d'Informations<br/>
                        ...
                        Assistant responsable de projet ERP Sage x3.<br/></p>
            ...
            <div class="flex md:contents">
                ...
                <div class="bg-gray-100 text-center col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md xpReveal">
