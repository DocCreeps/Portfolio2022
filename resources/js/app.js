...
ScrollReveal().reveal('.formationReveal', {delay : 250, distance: '120px',origin: 'top', duration: 1000, interval: 750 });


ScrollReveal().reveal('.projectPersoReveal', {delay : 250, distance: '200px',   rotate: {
        x: 50,
        z: 90
    }, duration: 1000, interval: 750 });
ScrollReveal().reveal('.projectEtuReveal', {delay : 250, distance: '120px',  rotate: {
        x: 50,
        z: 90
    }, duration: 1000, interval: 750 });
